...
in ''
  Config {
    ...
    template = " %battery% | %disku% | %cpu% | %memory%  } { <fc=${theme.PURPLE_COLOR}>OBS: %obs_scene%</fc> | DNS Hours: %dns_hours% | %date% | %time_norfolk% Norfolk | %time_paris% Paris | %time_la% Los Angeles",
    commands =
