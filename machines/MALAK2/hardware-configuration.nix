...
# to /etc/nixos/configuration.nix instead.
{
  ...
  fileSystems."/" = {
    device = "/dev/disk/by-uuid/780c689f-25b5-4207-9e07-812cb119244b";
    fsType = "ext4";
  };

  fileSystems."/boot" = {
    device = "/dev/disk/by-uuid/DD97-C643";
    fsType = "vfat";
  };

  swapDevices = [
    {device = "/dev/disk/by-uuid/c6b0ffaa-a822-4a9a-9a20-409346dc1bab";}
  ];
