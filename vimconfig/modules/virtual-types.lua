-- virtual-types plugin
-- Taken from https://github.com/jubnzv/virtual-types.nvim/blob/master/lua/virtualtypes.lua
-- License: MIT - https://github.com/jubnzv/virtual-types.nvim/blob/master/LICENSE
local vim = vim
local api = vim.api
local lsp = vim.lsp
